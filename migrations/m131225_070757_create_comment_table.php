...
class m131225_070757_create_comment_table extends \yii\db\Migration
{
	public function up()
	{
		...
		$this->addForeignKey('FK_comment_model_id', 'tbl_comment', 'model_id', 'tbl_task', 'id', 'CASCADE', 'RESTRICT');
	}
